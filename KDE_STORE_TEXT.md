# KDE Store copy/paste text — Die Lage v1.60.6
...
## Files to upload
- `die-lage-1.60.6.plasmoid`: KDE Store / Plasma widget package.
- `die-lage-v1.60.6.zip`: full installer bundle with helper scripts, systemd user units.
...
Latest installer ZIP direct link:
