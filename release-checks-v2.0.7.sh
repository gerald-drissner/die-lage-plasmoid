...
grep -q '"Version": "2.0.7"' files/plasmoid/metadata.json
grep -q 'readonly property string appVersion: "2.0.7"' files/plasmoid/contents/ui/main.qml
grep -q '"version": "2.0.7"' files/bin/dielage-server.py
grep -q 'DieLage/2.0.7' files/bin/dielage-cache.py
grep -q '<release version="2.0.7" date=' files/plasmoid/metadata.appdata.xml
