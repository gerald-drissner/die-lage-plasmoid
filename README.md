# Die Lage / Daily Briefing — v1.60.6
...
Die Store-Grafiken liegen in einem separaten Paket `die-lage-store-assets-v1.60.6.zip`. Darin enthalten:
...
1. `die-lage-1.60.6.plasmoid` für die normale Widget-Installation über Plasma/KDE Store.
2. `die-lage-v1.60.6.zip` als vollständiges Bundle mit Installer, Helper-Skripten und systemd-User-Units.
3. `die-lage-store-assets-v1.60.6.zip` als separates Paket mit KDE-Store-Grafiken.
